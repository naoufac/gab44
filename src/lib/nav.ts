...
export const CATEGORY: Record<string, { label: string; parent: string; parentHref: string }> = {
  ...
  inca_gods:          { label: 'Inca Gods',                    parent: 'Wisdom',   parentHref: '/wisdom' },
  persian_yazatas:    { label: 'Persian Yazatas',              parent: 'Wisdom',   parentHref: '/wisdom' },
  chinese_gods:       { label: 'Chinese Gods',                 parent: 'Wisdom',   parentHref: '/wisdom' },
  polynesian_gods:    { label: 'Polynesian Gods',              parent: 'Wisdom',   parentHref: '/wisdom' },
  mayan_gods:         { label: 'Mayan Gods',                   parent: 'Wisdom',   parentHref: '/wisdom' },
