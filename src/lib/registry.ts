...
export function getAllPages(): Page[] {
  ...
  pages.push({
    ...
    sections: [
      ...
      { heading: 'World pantheons', body: 'Fifteen world traditions of the divine: Hindu, Greek, Roman, Celtic, Yoruba (Orisha), Mesopotamian, Aztec, Shinto, Norse, Slavic, Egyptian, Chinese, Persian (Zoroastrian), Inca, Polynesian, Mayan. Plus the Wheel of the Year (Sabbats).', list: ['Hindu Devas', 'Olympian Gods', 'Roman Gods', 'Egyptian Gods', 'Celtic Gods', 'Orishas', 'Mesopotamian Gods', 'Aztec Gods', 'Shinto Kami', 'Norse Gods', 'Slavic Gods', 'Chinese Gods', 'Persian Yazatas', 'Inca Gods', 'Polynesian Gods', 'Mayan Gods', 'Wheel of the Year (Sabbats)'] },
    ],
  })
